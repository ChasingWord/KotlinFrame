...
import com.hebao.testkotlin.view.model3d.plane.PlaneGlRenderer;
import com.hebao.testkotlin.view.model3d.plane.Shape;
...
public class Cube extends Shape {
    ...
    public void init() {
        ...
        int vertexShader = PlaneGlRenderer.loadShader(GLES20.GL_VERTEX_SHADER,
                vertexShaderCode);
        int fragmentShader = PlaneGlRenderer.loadShader(GLES20.GL_FRAGMENT_SHADER,
                fragmentShaderCode);
        //创建一个空的OpenGLES程序
